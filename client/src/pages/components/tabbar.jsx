...
const Tabbar = () => {
  ...
  return (
    <div  className={`w-[80%] flex md:hidden  items-center  py-3 px-5 border bg-white mx-auto  border-gray-200 rounded-xl shadow-lg   gap-2 justify-between fixed z-10  bottom-3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 `}>
