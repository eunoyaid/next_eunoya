...
const CardCustomProduct = ({ item }) => {
  return (
    <Link href={`product/${item.id}`}>
      <div className=" min-h-[15rem]  min-w-[150px] bg-white border border-gray-100 dark:bg-gray-800  dark:border-gray-700  p-3 rounded-xl  overflow-hidden  lg:aspect-none ">
        ...
        <div className="mt-4 block md:flex justify-between">
          <div className="flex items-center space-x-4">  
            <p className="text-gray-500 text-xs">Tomo & Elvira Wedding</p>
          </div>
